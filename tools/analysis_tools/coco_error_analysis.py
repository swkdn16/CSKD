...
def main():
    ...
    parser.add_argument(
        '--result',
        default='work_dirs/mlkd_fcos_r50_distill_r18_fpn_coco_1x/test/test_fcos_distill_r18.bbox.json',
        help='result file (json format) path')
    parser.add_argument(
        '--out_dir',
        default='work_dirs/mlkd_fcos_r50_distill_r18_fpn_coco_1x/test',
