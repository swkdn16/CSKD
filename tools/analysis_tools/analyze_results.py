...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default='../../configs/mlkd/mlkd_fcos_r50_distill_r18_fpn_coco_1x.py',
        help='test config file path')
    parser.add_argument(
        '--prediction_path',
        default='../../configs/mlkd/mlkd_fcos_r50_distill_r18_fpn_coco_1x.py',help='prediction path where test pkl result')
    parser.add_argument(
        '--show_dir',
        default='../../configs/mlkd/mlkd_fcos_r50_distill_r18_fpn_coco_1x.py',
